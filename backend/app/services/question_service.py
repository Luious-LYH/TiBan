...
class QuestionService:
    ...
    def _sample_to_question(self, item: dict) -> Question:
        ...
        return Question(
            ...
            image_placeholder=f"{source_dataset} 公开 GI 内镜样例图像，本页仅用于医师训练与模型基准复核。",
            case_summary=f"{item.get('citation_note', '公开数据样例，仅用于教学训练。')} 当前题用于训练 {body_part} 相关观察与证据边界；中文题干和解释由平台按训练目标改写。",
            ...
            citation_note=item.get("citation_note", "公开数据样例，仅用于教学训练。"),
