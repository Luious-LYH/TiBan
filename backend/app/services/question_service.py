...
class QuestionService:
    ...
    def _sample_to_question(self, item: dict) -> Question:
        ...
        return Question(
            ...
            image_placeholder=f"{source_dataset} 脱敏公开样例图像，用于 v1.1 题库/模型测试演示。",
            case_summary=f"{item.get('citation_note', '公开数据样例，仅用于教学原型展示。')} 当前题用于训练 {body_part} 相关观察与证据边界。",
            ...
            citation_note=item.get("citation_note", "公开数据样例，仅用于教学原型展示。"),
