...
- Built a role-separated Question Factory with Parse/Index, Generator schema, deterministic gate, Provider Judge, revision-preserving Repair, and publish workflow. On a portfolio-sized review set, Judge precision improved from 0.2540 to 0.9412; the artifact records human-review limitations.
