...
export const mockDashboard: DashboardPayload = {
  ...
  platform_readiness: {
    ...
    demo_path: [
      ...
      { step: 3, title: '报告生成与修改', detail: '生成结构化草稿并用 AI judge 评分。', href: '/report', expected_state: '来源追踪 + 画像回灌' },
      { step: 4, title: '模型准入探测', detail: '测试用户自带 Provider。', href: '/models', expected_state: 'provider called 或 rule draft' },
    ],
