...
export function SessionBuilder({ bankId, bankName, triggerClassName = 'bank-start-action' }: { bankId: string; bankName: string; triggerClassName?: string }) {
  ...
  async function start() {
    ...
    try {
      ...
      const session = await createPracticeSession(bankId, 'demo_learner', mode, requestedCount)
