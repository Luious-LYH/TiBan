    ...
    lines: list[str] = [
        ...
        *table(
            ...
            [
                ...
                ["Provider", f"{summary.get('provider_mode')} · configured={provider.get('configured')} · real_inference_verified={provider.get('real_inference_verified')}"],
        ...
        *table(
            ...
            [
                ...
                ["Self-test logged", f"{provider.get('self_test_logged')} · count={provider.get('self_test_count')} · state={provider.get('latest_self_test_state')}"],
                ["Self-test verified", provider.get("self_test_verified")],
                ["Admission provider_called", provider.get("admission_provider_called")],
                ["Admission state kind", provider.get("admission_state_kind")],
                ["Admission safe_for_training", provider.get("admission_safe_for_training")],
                ["Real inference verified", provider.get("real_inference_verified")],
                ["Verification label", provider.get("verification_label")],
                ["Verification note", provider.get("verification_note")],
            ],
        ),
        "",
        "## 当前能力边界",
